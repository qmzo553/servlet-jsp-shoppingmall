            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li>
                            <a href="/admin/categoryPage.do" class="btn btn-info btn-sm">관리자페이지</a>
                        </li>
                    </ul>
                    ...
                    <div class="text-end">
                        <%
                            ...
                            if (userId != null) {
                        %>
                        <a class="btn btn-primary" href="/order/view.do">주문하기</a>
                        <!-- 로그아웃 버튼 -->
                        ...
                        <a class="btn btn-warning" href="/user/register.do" >회원가입</a>
                        <%
                            }
                        %>
                    </div>
