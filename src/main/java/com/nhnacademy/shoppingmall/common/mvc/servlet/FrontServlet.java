...
import com.nhnacademy.shoppingmall.controller.exception.ExceptionHandler;
...
public class FrontServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        super.init(config);
        controllerFactory = (ControllerFactory) config.getServletContext().getAttribute(CONTEXT_CONTROLLER_FACTORY_NAME);
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try{
            ...
            ExceptionHandler.execute(req, resp, e);
        }finally {
            // connection을 반납합니다.
            DbConnectionThreadLocal.reset();
        }
