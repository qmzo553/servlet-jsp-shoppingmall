...
public class ProductRegistrationPostController implements BaseController {
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            Product product = new Product(productName, productPrice, productStock, productImg, categoryId);
