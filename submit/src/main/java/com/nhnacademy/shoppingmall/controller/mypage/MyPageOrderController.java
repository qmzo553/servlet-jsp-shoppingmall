...
public class MyPageOrderController implements BaseController {
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        Page<Order> orderPage = orderService.getOrders(userId, currentPage, pageSize);

        int pageBlock = 5; // 한 페이지 버튼 수
        int totalCount = (int) orderService.getOrderTotalCount(userId); // 총 데이터 갯수
        ...
        return "shop/mypage/mypage_order";
    }
}
